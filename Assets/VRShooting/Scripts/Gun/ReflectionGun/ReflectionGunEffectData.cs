...
{
    public class ReflectionGunEffectData : MonoBehaviour, IEffectData
    {
        [SerializeField] private GenericEffectData<ReflectionGunEffectDataType> _effectData;
        ...
        public VisualEffect GetVisualEffect<TKey>(TKey key) where TKey : Enum
        {
            ...
            // Intから特定のEnum型へ変更
            var convertedKey = (ReflectionGunEffectDataType)value;
            // 値を返す
