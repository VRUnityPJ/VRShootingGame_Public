...
namespace VRShooting.Scripts.Gun
{
    ...
    /// </summary>
    public class AutoShotGunData : MonoBehaviour, IGunData
    {
        ...
        /// </summary>
        [SerializeField] private GenericWeaponData<AutoShotGunDataType> _weaponData;
            ...
            where TKey : Enum
        {
            ...
            // Intから特定のEnum型へ変更
            var convertedKey = (AutoShotGunDataType)value;
            // 値を返す
